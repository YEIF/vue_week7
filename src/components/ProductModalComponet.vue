          ...
          <div class="col-sm-4">
            <div class="mb-2">
              ...
              <div v-if="Array.isArray(localProduct.imagesUrl)">
                <!-- 陣列有值就顯示 -->
                <div class="mb-1" v-for="(image, key) in localProduct.imagesUrl" :key="key">
                  <div class="mb-3">
                    <label for="imageUrl" class="form-label">圖片網址</label>
                    <input v-model="localProduct.imagesUrl[key]" type="text" class="form-control"
                      placeholder="請輸入圖片連結">
                  </div>
                  <img class="img-fluid" :src="image">
                </div>
                <div
                  v-if="!localProduct.imagesUrl.length || localProduct.imagesUrl[localProduct.imagesUrl.length - 1]">
          ...
          <div class="col-sm-8">
            ...
            <div class="mb-3">
              <div class="form-check form-switch">
                <input type="checkbox" class="form-check-input" :id="localProduct.id"
                  v-model="localProduct.is_enabled" :true-value="1" :false-value="0">
